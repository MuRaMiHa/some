...
{	// Create our Plugin function, with $ as the argument (we pass the jQuery object over later)
	...
	{	// Our LightboxClass definition
		...
		files: {
			compressed: {
				scripts: {
					lightbox:	'lightbox/js/jquery.lightbox.min.js',
					colorBlend:	'lightbox/js/jquery.color.min.js'
				},
				styles: {
					lightbox:	'lightbox/css/jquery.lightbox.css'
				}
			},
			uncompressed: {
				scripts: {
					lightbox:	'lightbox/js/jquery.lightbox.js',
					colorBlend:	'lightbox/js/jquery.color.js'
				},
				styles: {
					lightbox:	'lightbox/css/jquery.lightbox.css'
				}
			...
			images: {
				prev:		'lightbox/images/btn-prev.png',
				next:		'lightbox/images/btn-next.png',
				blank:		'lightbox/images/blank.gif',
				loading:	'lightbox/images/loading.gif'
			}
		},
		...
		domReady: function ( )
		{
			...
			$('body').append('<div id="lightbox-overlay"></div><div id="lightbox"><div id="lightbox-imageBox"><div id="lightbox-imageContainer"><img id="lightbox-image" /><div id="lightbox-nav"><a href="#" id="lightbox-nav-btnPrev"></a><a href="#" id="lightbox-nav-btnNext"></a></div><div id="lightbox-loading"><a href="#" id="lightbox-loading-link"><img src="' + this.files.images.loading + '" /></a></div><a href="#" id="lightbox-close"><span></span></a></div></div></div>');
			...
			// Assign close clicks
			$('#lightbox-overlay, #lightbox, #lightbox-loading-link, #lightbox-btnClose, #lightbox-close').unbind().preventDefault().lastclick(function() {
				$.Lightbox.finish();
				return false;	
			});
...
/*
     FILE ARCHIVED ON 09:46:44 Dec 11, 2012 AND RETRIEVED FROM THE
...
/*
playback timings (ms):
  captures_list: 184.899
  exclusion.robots: 0.068
  exclusion.robots.policy: 0.059
  cdx.remote: 0.055
  esindex: 0.01
  LoadShardBlock: 140.472 (3)
  PetaboxLoader3.datanode: 61.906 (4)
  PetaboxLoader3.resolve: 109.72 (2)
  load_resource: 66.738
*/